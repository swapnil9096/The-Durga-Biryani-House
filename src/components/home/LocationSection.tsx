        ...
        <div>
          ...
          <address className="mt-6 space-y-4 not-italic">
            <div className="flex items-start gap-3">
              <span className="mt-0.5 text-maroon-700" aria-hidden="true">
                📍
              </span>
              <p className="text-charcoal-700">{fullAddress}</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 text-maroon-700" aria-hidden="true">
                🕑
              ...
              <p className="text-charcoal-700">
                ...
                <span className="text-charcoal-500">(till 11:30 PM Fri–Sun)</span>
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 text-maroon-700" aria-hidden="true">
              ...
              <a
                ...
                className="text-charcoal-700 hover:text-maroon-700"
              >
